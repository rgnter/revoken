package eu.battleland.revoken.statics;
...
public class PktStatics {
     ...
     * @return packet
     */
    public static PacketPlayOutWorldParticles makeParticlePacket(@NotNull ParticleType particle, boolean overrideLimiter, org.bukkit.util.Vector loc, @NotNull Vector offset, float speed, int count) {
